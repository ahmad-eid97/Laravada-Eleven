    ...
    <header :class="!topOfPage ? 'onScroll' : ''" class="header header-style-2 clearfix">
        ...
        <div class="row m-0 w-100">
            <b-navbar toggleable="lg">
                <b-navbar-brand href="/">
                    <img src="/assets/images/logo.png" alt="logoImage" style="margin: 10px 0">
                </b-navbar-brand>
                ...
                <b-collapse id="navbar-toggle-collapse" class="ml-auto justify-content-end" is-nav>
                    <b-navbar-nav class="align-items-center">
                        <b-nav-item :to="localePath('/')" href="#">Home</b-nav-item>
                        <b-nav-item :to="localePath('/about')">About Us</b-nav-item>
                        <b-nav-item :to="localePath('/services')">Services</b-nav-item>
                        <b-nav-item :to="localePath('/testimonials')">Testimonials</b-nav-item>
...
<style lang="scss">
    ...
    .nav-item.active .nav-link {
     ...
     .nav-item:hover .nav-link {
         background-color: rgba(117,179,37,.2);
    }
